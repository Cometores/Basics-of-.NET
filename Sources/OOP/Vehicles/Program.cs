...
namespace Vehicles
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            Bicycle bmx = new Bicycle("Turbo-V22xB", BicycleTypes.Bmx, false);
            Bicycle bicycle = new Bicycle("StraßenKiller", BicycleTypes.Cargo, true);
            Car golf = new Car("Golf", 5, 4, CarManufacturerTypes.Volkswagen, true);
            Car supra = new Car("Supra", 2, 2, CarManufacturerTypes.Toyota, false);
